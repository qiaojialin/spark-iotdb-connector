...
import query.analyzer.exception.*;
import query.analyzer.operator.FilterOperator;
import query.analyzer.optimizer.logical.DNFFilterOptimizer;
import query.analyzer.optimizer.logical.MergeSingleFilterOptimizer;
import query.analyzer.optimizer.logical.RemoveNotOptimizer;
import query.analyzer.optimizer.physical.PhysicalOptimizer;
...
public class Analyse {
    public List<TSFileQuery> analyse(FilterOperator filter, List<String> paths, String url, String deviceType, Long start, Long end) throws SQLException, ClassNotFoundException, LogicalOptimizeException, DNFOptimizeException, QueryProcessorException, QueryOperatorException, RemoveNotException, BasicOperatorException {
        ...
        if(filter != null) {
            ...
            } catch (com.corp.tsfile.qp.exception.logical.operator.BasicOperatorException e) {
                e.printStackTrace();
            }
